  ...
  describe('Test SVG functions (next):', () => {
    ...
    describe('Test SVG.transformAttrToObj();', () => {
      ...
      it('Expects this object to have all its own properties with the null value.', () => {
        ...
        expect(obj).to.have.property('translate').that.is.null;
        expect(obj).to.have.property('scale').that.is.null;
        expect(obj).to.have.property('rotate').that.is.null;
        expect(obj).to.have.property('matrix').that.is.null;
        expect(obj).to.have.property('skewX').that.is.null;
        expect(obj).to.have.property('skewY').that.is.null;
      });
      ...
      it('Expects this object to have the property translate equal to {x: null, y: null}.', () => {
        ...
        expect(obj.translate).to.have.property('x').that.is.null;
        expect(obj.translate).to.have.property('y').that.is.null;
      });
      ...
      it('Expects this object to have the property scale equal to {x: null, y: null}.', () => {
        ...
        expect(obj.scale).to.have.property('x').that.is.null;
        expect(obj.scale).to.have.property('y').that.is.null;
      });
      ...
      it('Expects this object to have the property rotate equal to {a: null, cx: null, cy: null}.', () => {
        ...
        expect(obj.rotate).to.have.property('a').that.is.null;
        expect(obj.rotate).to.have.property('cx').that.is.null;
        expect(obj.rotate).to.have.property('cy').that.is.null;
      });
      ...
      it('Expects this object to have the property skewX that is null}.', () => {
        expect(SVG.transformAttrToObj('skewX()')).to.have.property('skewX').that.is.null;
      });
      ...
      it('Expects this object to have the property skewY that is null}.', () => {
        expect(SVG.transformAttrToObj('skewY()')).to.have.property('skewY').that.is.null;
      });
      ...
      it('Expects this object to have the property matrix that is null}.', () => {
        expect(SVG.transformAttrToObj('matrix()')).to.have.property('matrix').that.is.null;
      });
      ...
      it('Expects this object to have the property matrix that is null}.', () => {
        expect(SVG.transformAttrToObj('matrix(1, 2, 3, 4, 5, 6)')).to.have.property('matrix').that.is.null;
      });
    });
  });
};
